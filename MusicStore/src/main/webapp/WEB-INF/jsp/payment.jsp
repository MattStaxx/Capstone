				...
				<sec:authorize access="isAuthenticated()">
					<div class="dropdown text-end">
						<a href="#"
							...
							aria-expanded="false"> <img src="images/lion.jpg"
			...
			<div class="col-md-4 order-md-2 mb-4">
				...
				<ul class="list-group mb-3">
					...
					<c:forEach items="${products}" var="product">
						<li
							...
							<div>
								...
								${product.quantity} item(s) = $${product.price *
					...
					<li class="list-group-item d-flex justify-content-between bg-light">
						...
						</div> <span class="text-success">-${discount}</span>
					</li>
					...
					<div class="row">
						...
						<div class="col-md-4 mb-3">
							<label for="state">State</label> <input class="form-control"
								type="text" name="state" maxlength="2" placeholder="TX">
					...
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label for="cc-number">Credit card number</label> <input
								type="text" class="form-control" name=cardnumber id="cc-number"
					...
					<div class="row">
						<div class="col-md-3 mb-3">
							<label for="cc-expiration">Expiration</label> <input type="text"
								class="form-control" name=expire id="cc-expiration"
								placeholder="" required>
							<div class="invalid-feedback">Expiration date required</div>
						</div>
						<div class="col-md-3 mb-3">
							<label for="cc-expiration">CVV</label> <input type="text"
								class="form-control" name=cvv id="cc-cvv" placeholder=""
								required>
